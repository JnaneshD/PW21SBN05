...
UPLOAD_FOLDER = 'C:/Users/acer/Desktop/SSD/newimages/PW21SBN05_Weekly_reports'
...
def push_git():
    os.chdir("newimages")
    os.chdir("PW21SBN05_Weekly_reports")
    os.system("git add .")
...
def run_demo(cfg, ckpt, score_threshold, image_path, dataset_type):
    ...
    response = {}
    img = cv2.imread("newimages/PW21SBN05_Weekly_reports/imageToSave.jpg")
...
def crop_images(ssd_d,yolo_d):
    ...
    for i in output:
        for j in output[i]:
            ...
            cv2.imwrite("newimages/PW21SBN05_Weekly_reports/"+i+time_cur+".png",cropped)
            frontend[i+time_cur] = ''
    push_git()
    return frontend
...
def upload_file():
    ...
    if request.method == 'POST':
        ...
        result = {}
        yolo_detections = {}
        with open("newimages/PW21SBN05_Weekly_reports/imageToSave.jpg", "wb") as fh:
